...
//for calling during step2, updates if filesize is large enough.
//void UpdateFileCount(ToSave *TheFiles, 
//					 int numfiles,
//					 std::string DataCollectedBaseDir){
//
//
...
//			if ( ((long long) buffer.st_size) > 65536 ) {
...
////		int bytecount;
////		fin >> bytecount;
//		  if (bytecount > 65536){//67108864){//64*int(pow(double(2),double(20))) = 67108864
//			
//			TheFiles[i].filecount+=1;
//		}
//
